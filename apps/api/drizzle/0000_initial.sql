...
CREATE UNIQUE INDEX `events_ulid_idx` ON `events` (`ulid`);--> statement-breakpoint
CREATE TABLE `users` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `users_auth0_sub_idx` ON `users` (`auth0_sub`);--> statement-breakpoint
